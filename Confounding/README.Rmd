...
* wie werden die Paraameter eines Poisson- resp. neg.-binomialen Modells interpretiert?
    * Intercept: durchschnittliche Anzahl Konsultationen der referenzkategorie
    * Koeffizienten: Faktoren auf Intercept
* soll die Zielvariable logarhythmiert werden? wohl eher nicht, da Poisson-Verteilung. 
Allerdings ist der Test in der Tabelle mit den Baseline-Charakteristika fraglich.
    * die Link-Funktion ist der Logarhythmus! Koeffizienten exponentieren!
